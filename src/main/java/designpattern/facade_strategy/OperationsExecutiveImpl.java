...
public class OperationsExecutiveImpl implements OperationsExecutive {
	...
	public OperationsExecutiveImpl(DesignationTypes designation, String joblevel, String projectCode, int employeeID,
			String employeeName) {
		super();
	...
	public OperationsExecutiveImpl() {
	}
	
	@Override
	public void workAsSOE(InfosysEmployee employee) {
		// TODO Auto-generated method stub

	}

	@Override
	public void workAsSE(InfosysEmployee employee) {
		// TODO Auto-generated method stub
	...
	@Override
	public void workAsOE(InfosysEmployee employee) {
		// TODO Auto-generated method stub
	...
	public String toString() {
		return "OperationsExecutiveImpl [designation=" + designation + ", joblevel=" + joblevel + ", projectCode="
