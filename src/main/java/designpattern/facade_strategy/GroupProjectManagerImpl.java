...
public class GroupProjectManagerImpl implements GroupProjectManager {
	...
	public GroupProjectManagerImpl(DesignationTypes designation, String joblevel, String projectCode, int employeeID,
			String employeeName) {
		super();
	...
	public GroupProjectManagerImpl() {
	}
	...
	public String toString() {
		return "GroupProjectManagerImpl [designation=" + designation + ", joblevel=" + joblevel + ", projectCode="
