...
public class SeniorProjectManagerImpl implements SeniorProjectManager {
	...
	public SeniorProjectManagerImpl(DesignationTypes designation, String joblevel, String projectCode, int employeeID,
			String employeeName) {
		super();
	...
	public SeniorProjectManagerImpl() {
	}
	...
	public String toString() {
		return "SeniorProjectManagerImpl [designation=" + designation + ", joblevel=" + joblevel + ", projectCode="
